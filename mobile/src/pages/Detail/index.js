...
export default function Details() {
    ...
    const message = `Olá ${incident.name}, stou entrando em contato pois gostaria de ajuda no caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(incident.value)} `;
    ...
    function sendEmail() {
        MailComposer.composeAsync({
            ...
            recipients: ['luisgustavovieirasantos@gmail.com'],
            body: message
        });
    }
